...
class GridPath {
    ...
    getNextEmptyCell(prev, direction, randomness = 0.95, rank = 0) {
        if (direction == null) {
    ...
    // }
    GenerateArrow(startCell, length, rank) {
    ...
    ValidateLevel() {
        ...
        function validateArrowExit(arrow, grid) {
...
class Arrow {
    ...
    IsBlocked(ray) {
        if (!ray)
            ray = gridPath.getArrowHeadRay(this);
